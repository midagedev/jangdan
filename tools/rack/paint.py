...
PROMPTS={
 ...
 'poly': STYLE+' One horizontal synthesizer module of an electronic groovebox: a teal blue section stripe on the left edge, one row of eight small round black rotary knobs with cream pointer marks and tick marks, a small blank cream label plate under each knob, a blank cream name plate at the top left,'+COMMON,
 'sampler': STYLE+' One horizontal sampler module of an electronic groovebox: a dusty rose pink section stripe on the left edge, one row of eight small round black rotary knobs with cream pointer marks and tick marks, a small blank cream label plate under each knob, a blank cream name plate at the top left, and one small dark green rectangular display screen with a faint horizontal line at the top right,'+COMMON,
