...
// p4fx2HashV1 — 기본 파라미터 30초 seed 1 해시(재기준 상수, P4-fx2).
// 변경 전(cde82a5b…c4d12) → 딜레이 센드 전환 후 이 값. 리버브·코러스·레벨은
// 기본값(센드 0·레벨 1.0)에서 바이트에 닿지 않는다 — "딜레이 센드만 넣은 중간
// 상태"의 해시와 최종 상태의 해시가 같음을 두 번 실측해 확인했다(라운드 보고).
const p4fx2HashV1 = "58d944c2c33dc98c36a4e6e2cd0a6a969ee9bbff9674f7fe4a7b7b31226d27b3"
